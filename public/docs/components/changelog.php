<section id="changelog">
    ...
    <ul class="changelog">
        ...
        <li><span class="badge badge-success">Toegevoegd</span> Plekken count op P4</li>
        <li><span class="badge badge-success">Toegevoegd</span> Dashboard data export naar PDF & Excel</li>
        <li><span class="badge badge-success">Toegevoegd</span> Meerdere docenten per examen</li>
        <li><span class="badge badge-success">Toegevoegd</span> Examen reglement</li>
        <li><span class="badge badge-success">Toegevoegd</span> Examens soft delete toevoegen</li>
        <li><span class="badge badge-success">Toegevoegd</span> Breadcrumbs op front-end en beheer kant</li>
        <li><span class="badge badge-success">Toegevoegd</span> Nederlandse vertaling toevoegen</li>
    ...
    <ul class="changelog">
        <li><span class="badge badge-success">Toegevoegd</span> Waarschuwing popup bij het wisselen van examen</li>
        <li><span class="badge badge-success">Toegevoegd</span> Waarschuwing popup bij het wisselen van examen moment</li>
        <li><span class="badge badge-success">Toegevoegd</span> Waarschuwing popup als er velden leeg zijn</li>
        <li><span class="badge badge-success">Toegevoegd</span> Examen CRUD</li>
        <li><span class="badge badge-success">Toegevoegd</span> Afspraak validatie via e-mail</li>
        <li><span class="badge badge-fixed">Opgelost</span> Enkele kleine bugs voor responsiveness</li>
        <li><span class="badge badge-info">Bijgewerkt</span> CSS & JS verbeteringen</li>
        <li><span class="badge badge-info">Bijgewerkt</span> Spelling & zinsopbouw</li>
    ...
    <h3 id="changelog_v1.0">Versie 1.0 <small class="text-muted">(24 oktober 2021)</small></h3>
    <p>Eerste uitgave</p>
</section>