...
<form action="{{ route('examens.destroy', $examen->id) }}" method="post">
    <div class="modal-body">
        @csrf
        @method('DELETE')
        <h5 class="text-center">Weet je het zeker dat je examen <span class="fc-secondary">"{{ $examen->vak }} {{ $examen->examen }}"</span> wilt terug zetten?</h5>
    </div>
    <div class="modal-footer-custom">
            <div class="mt-4">
                ...
                <x-jet-button class="button float-right">
                    Ja, zet het examen terug <i class="fas fa-forward ml-2"></i> 
                </x-jet-button>
            </div>
    </div>
</form>