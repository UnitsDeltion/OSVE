            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="tijd" class="block mt-1 w-full form-control" type="text" name="tijd" value="{{ $moment['tijd'] }}"/>
                    </div>
                </div>
                @endforeach
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="plaatsen" class="block mt-1 w-full form-control" type="number" name="plaatsen" value="{{ $examen['plaatsen'] }}"/>
                    </div>
                </div>
