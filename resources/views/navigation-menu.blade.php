<nav x-data="{ open: false }" class="bg-primary-nh border-b border-gray-100">
        ...
        <div class="flex justify-between h-17">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('p1') }}">
                        <img class="h-13 logoMobile" src="{{ asset('images/logos/logo.svg') }}" />
                    </a>
                </div>
            </div>
                    ...
                    <div class="ml-3 relative">
                        <x-jet-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                @else
                                    <span class="inline-flex rounded-md">
                                        <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition a-clear">
                            ...
                            <x-slot name="content">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <x-jet-dropdown-link href="{{ route('logout') }}"  class="fc-primary"
